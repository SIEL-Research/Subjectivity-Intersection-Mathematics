...
\hypersetup{
  ...
  citecolor=SIELblue,
  urlcolor=SIELblue,
  pdftitle={Subjectivity-Intersection Mathematics: A Mathematical Research Program for Relational Generation},
...
\fancyhead[R]{\small\sffamily Public Working Preprint v1.0}
...
\thispagestyle{empty}
\vspace*{18mm}
{\sffamily\bfseries\color{SIELblue}\fontsize{25}{30}\selectfont
\mbox{Subjectivity-Intersection}\\Mathematics\par}
\vspace{7mm}
{\sffamily\fontsize{18}{23}\selectfont
A Mathematical Research Program\\for Relational Generation\par}
...
\noindent\colorbox{SIELlight}{%
  ...
  \vspace{2mm}
  \textbf{Document status:} Public Working Preprint, Version 1.0\\
  \textbf{Date:} 4 August 2026\\
  \textbf{DOI:} \href{https://doi.org/10.5281/zenodo.21781152}{10.5281/zenodo.21781152}\\
  ...
  This version establishes a citable statement of the framework and the computational results through Experiment 006R. It remains a working preprint and may be revised in later versions.
  \vspace{2mm}
  }}
...
\begin{abstract}
Recent work in multi-agent learning and complex systems has produced many forms of relational representation, but relation generation itself remains underdeveloped as a mathematically defined and falsifiable object. This paper proposes \emph{Subjectivity-Intersection Mathematics} as a research program for that purpose.
...
\noindent\textbf{Keywords:} subjectivity-intersection mathematics; relational generation; relational carrier; self-re-entry; O3; multi-agent learning; counterfactual intervention; distributed representation; preregistration
...
The program did not ask a single experiment to establish every claim. It separated five questions:
\begin{enumerate}
...
\end{equation}
Failure of any registered condition prevented a supported primary decision even when all other conditions passed. This rule is why Experiment 006 remains \statusnotsupported. Experiment 006R did not overwrite that result; it formulated and tested two new, separable claims on previously unused seeds.
...
The relational contribution need not appear as a single shared memory. In distributed systems it can be mixed across the persistent states of (A) and (B). Its operational identity is then supplied by interventions and counterfactual contrasts rather than spatial localization. The boundary found in Experiment 006R suggests that models of relational generation should distinguish at least three levels: causal function, representational distribution, and external recoverability.
...
The staged experiments moved from explicitly constructed sufficiency to spontaneous formation under ordinary reciprocal learning and then to causal self-re-entry. Experiment 005 identified a carrier-like solution class across four equal-capacity interaction architectures without a dedicated carrier state or objective. Experiment 006 preserved a preregistered failure despite universal random-control transport. Experiment 006R then confirmed the separated primary re-entry claim in 190 of 192 new architecture-seed units and confirmed the predicted boundary between functional re-entry and external identifiability.
...
This version marks the beginning rather than the completion of the program. Its public purpose is to state the framework and the Experiment 003R--006R evidence boundary in a stable, citable form from which a general theory of relational generation can be developed.
...
The following records contain preregistrations, frozen implementations, result reports, manifests, and generated outputs.

\begin{longtable}{@{}>{\raggedright\arraybackslash}p{1.4cm}>{\raggedright\arraybackslash}p{4.4cm}>{\raggedright\arraybackslash}p{8.2cm}@{}}
\toprule
Study & Public record & Persistent registration or record \\
\midrule
\endhead
003R & \href{https://github.com/SIEL-Research/Subjectivity-Intersection-Mathematics/tree/main/experiments/003r_subjectivity_agent_class2_o3_corrected}{Corrected operational sufficiency experiment} & \href{https://doi.org/10.5281/zenodo.21761030}{doi:10.5281/zenodo.21761030}. The invalid Experiment 003 execution and audit are preserved separately at \href{https://doi.org/10.5281/zenodo.21760837}{doi:10.5281/zenodo.21760837}. \\
004 & \href{https://github.com/SIEL-Research/Subjectivity-Intersection-Mathematics/tree/main/experiments/004_difference_preserving_o3_discrimination}{Difference-preserving and retained-history audit} & \href{https://doi.org/10.5281/zenodo.21761975}{doi:10.5281/zenodo.21761975} \\
005 & \href{https://github.com/SIEL-Research/Subjectivity-Intersection-Mathematics/tree/main/experiments/005_emergent_relational_carrier_solution_class}{Emergent carrier solution class} & \href{https://doi.org/10.5281/zenodo.21763898}{doi:10.5281/zenodo.21763898} \\
006 & \href{https://github.com/SIEL-Research/Subjectivity-Intersection-Mathematics/tree/main/experiments/006_spontaneous_o3_reentry}{Spontaneous operational O3 re-entry} & \href{https://doi.org/10.5281/zenodo.21764327}{doi:10.5281/zenodo.21764327} \\
006R & \href{https://github.com/SIEL-Research/Subjectivity-Intersection-Mathematics/tree/main/experiments/006r_spontaneous_o3_reentry_revised}{Revised confirmation and architecture boundary} & \href{https://doi.org/10.5281/zenodo.21764531}{doi:10.5281/zenodo.21764531} \\
\bottomrule
\end{longtable}

The preregistered decision for Experiment 006 remains \statusnotsupported. The record for Experiment 006R is a result-informed, separately preregistered revision using previously unused seeds. Readers should not combine the two decisions into a single retrospective success claim.
...
\begin{center}
\small\sffamily
Public Working Preprint v1.0 --- 4 August 2026\\
