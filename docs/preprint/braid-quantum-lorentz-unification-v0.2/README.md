# Braid–Quantum–Lorentz Unification Preprint v0.2

This directory preserves the public source, reviewed PDF, metadata, and verification materials for:
...
- [v0.1 public package](../braid-quantum-lorentz-unification-v0.1/README.md)
- [v0.1 Zenodo DOI](https://doi.org/10.5281/zenodo.22693965), publication date 10 September 2026

## Build

Run XeLaTeX twice from this directory. The committed PDF SHA-256 is:

```text
d82108d9942305a7074a41614cf756cfa30703033fd86c0eeb9be7a1cabee051
```

## License

The preprint and authoring source are released under CC BY 4.0. Verification code is released under the repository's Apache License 2.0.
