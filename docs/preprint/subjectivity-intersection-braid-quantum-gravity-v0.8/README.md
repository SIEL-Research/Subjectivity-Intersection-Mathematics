# Subjectivity-Intersection Braid Quantum Gravity v0.8
...
In one fixed pointed-Braid source model, v0.8 constructs a source-derived four-direction carrier, a Lorentz-signature event metric, quantum dynamics on the same carrier, continuous metric/nonmetricity fields, positive local transport, a typed physical solder, Hilbert stress, an on-shell Ward identity, and the scoped low-energy equation
...
v0.8 supersedes v0.7 as the current full manuscript but does not overwrite any earlier public version. The older 32-page v0.7 full preprint and 13-page v0.7 concise note remain preserved in their original directory.
